...
class IFRS17Processor:
    ...
    def get_IFRS17_template(self):
        try:
            df = pd.read_excel("C:/Users/dkirungu.ICEALIONGROUP/Documents/finance/reporting/revenue_account/input_data/IFRS 17 APRIL 2025 TEMPLATE Revenue account and Balance sheet. - After April 2025 LC.xlsx", sheet_name='template')
            ...
            result.rename(index={f'YTD_Apr_2025': f'YTD_{MONTH}_2026'}, inplace=True)
    ...
    def get_prev_bel(self):
        try:
            ...
            # logger.info(prev_realigned_bel['LIC Risk Adjustments Event'])
    ...
    def update_reinsurance_section(self, revenue_account_template):
            try:
                ...
                revenue_account_template = revenue_account_template.apply(pd.to_numeric, errors='coerce')
